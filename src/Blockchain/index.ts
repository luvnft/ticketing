    ...
    const res = await axios.post(
      ...
      data,
      {
        ...
        headers: {
          ...
          Authorization: `Bearer ${'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..6YgjHTNk3xeavkB0VIz3s2am2lOpeJVNqD_phPHpRHg'}`,
        },
      }
    );
